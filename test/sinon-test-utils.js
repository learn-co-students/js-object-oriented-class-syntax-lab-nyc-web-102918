! function(r, t) {
  "object" == typeof exports && "object" == typeof module ? module.exports = t(require("sinon")) : "function" == typeof define && define.amd ? define(["sinon"], t) : "object" == typeof exports ? exports.SinonSpyUtils = t(require("sinon")) : r.SinonSpyUtils = t(r.sinon)
}(this, function(r) {
  return function(r) {
    function t(e) {
    ...
    var e = n(0),
      ...
      i = (t.Mock = function() {
        ...
        var e = {},
          ...
          f = void 0;
        try {
          for (var l, a = t[Symbol.iterator](); !(i = (l = a.next()).done); i = !0) {
        ...
        try {
          ...
          var d = !0,
            ...
            v = void 0;
          try {
            for (var b, h = e[Symbol.iterator](); !(d = (b = h.next()).done); d = !0) {
              u[b.value].restore()
            }
          } catch (r) {
            p = !0, v = r
